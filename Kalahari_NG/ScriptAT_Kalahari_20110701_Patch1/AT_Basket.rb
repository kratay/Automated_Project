...
class Untitled <  Test::Unit::TestCase	  
	...
	def test_untitled	
		...
		if bReturn == true			
			@seleniumnew.gotoBasketPage(@@loctgotoBasket, @@loctGetBasketEmpty, "Basket (Empty): Goto Empty Basket page. ", "BS01: Test blank Basket page."); # BS01 - Blank Basket
			@seleniumnew.gotoContinueShopping(@@loctContShoppingEmpt, $loctHomepage, "BS02: Click Continue Shopping in blank Basket page."); # BS02 - Continue Shopping in blank Basket
			puts "BS02: Completed."
			
			@seleniumnew.pstAddCorrToBasket($PD_aProd1, "1", true); puts "BS03 - Add Product completed."; # BS03 - Add Product 			
			...
			@seleniumnew.gotoContinueShopping(@@loctContShopBtn, $loctHomepage, "BS03: Click Continue Shopping in Basket page."); puts "BS03 - Then click Continue Shopping completed."; # BS03 - Then click Continue Shopping		
			iQty = 2;
			@seleniumnew.pstAddCorrToBasket($PD_aProd1, "1", true); puts "BS04 - Add Product completed."; # BS04 - Add Product
			@seleniumnew.gotoBasketPage(@@loctgotoBasket, @@loctBasketPage, "Basket: Goto Basket page.");
			mySubTot = @seleniumnew.chkItemTotalPrice(@@loctBasketBody, @@loctBasketSubTot); puts "BS04 - then check total price completed."; # BS04 - then check total price
			@seleniumnew.chkItemSubTotal(@@loctBasketSubTot, mySubTot); puts "BS04 - then Check sub total completed."; # BS04 - then Check sub total			
			@seleniumnew.chkMatchProductBody($PD_aProd1, @@loctBasketBody, iQty); puts "BS06 - BS08 check Product Name, Price ,Qty completed."; # BS06 - BS08 check Product Name, Price ,Qty
		
			@seleniumnew.chkUpdateQTY(@@loctQTYUpd, @@loctUpdBasketBtn, "", "", false, "BS09: Leave blank in QTY box."); puts "BS09 - Leave blank in Qty box completed"
			@seleniumnew.chkUpdateQTY(@@loctQTYUpd, @@loctUpdBasketBtn, "QA", "", false, "BS10: Input character in QTY box."); puts "BS10 - Input character in QTY box completed"
			
			iQty = 3;
			@seleniumnew.pstAddCorrToBasket($PD_aProd1, "1", true); puts "BS11 - Input number in QTY box completed";
			@seleniumnew.gotoBasketPage(@@loctgotoBasket, @@loctBasketPage, "Basket: Goto Basket page.");
			mySubTot = @seleniumnew.chkItemTotalPrice(@@loctBasketBody, @@loctBasketSubTot); puts "BS11 - check Total Price completed";
			@seleniumnew.chkItemSubTotal(@@loctBasketSubTot, mySubTot); puts "BS11 - check Sub Total completed";
			@seleniumnew.chkMatchProductBody($PD_aProd1, @@loctBasketBody, iQty);
			
			@seleniumnew.pstAddCorrToBasket($PD_aProd2, "1", true); puts "BS12 - Add Product completed.";
			@seleniumnew.gotoBasketPage(@@loctgotoBasket, @@loctBasketPage, "Basket: Goto Basket page.");
			mySubTot = @seleniumnew.chkItemTotalPrice(@@loctBasketBody, @@loctBasketSubTot); puts "BS12 - check Total Price completed";
			@seleniumnew.chkItemSubTotal(@@loctBasketSubTot, mySubTot); puts "BS12 - check Sub Total completed";
			@seleniumnew.chkRemoveItem(@@loctBasketBody, @@loctBasketSubTot, @@loctContShoppingEmpt); puts "BS12 - then Remove Product completed";
			
			@seleniumnew.pstAddCorrToBasket($PD_aProd2, "1", true); puts "BS13 - Add Product completed";
			@seleniumnew.gotoBasketPage(@@loctgotoBasket, @@loctBasketPage, "Basket: Goto Basket page.");
			mySubTot = @seleniumnew.chkItemTotalPrice(@@loctBasketBody, @@loctBasketSubTot); puts "BS13 - check Total Price completed";
			@seleniumnew.chkItemSubTotal(@@loctBasketSubTot, mySubTot); puts "BS13 - check Sub Total completed"; 			
			#@seleniumnew.chkRemoveItem(@@loctBasketBody, @@loctBasketSubTot, @@loctContShoppingEmpt); puts "BS13 - then Remove Product completed";
			...
			@seleniumnew.logoutUser($loctGotoLogout, "BS14 - Logout User to completed this."); # Logout			
			...
			@seleniumnew.loginUser(@@loctRgstEmailText, 
				...
				true);
			#self.clickButton(@@loctHomepage); # Goto Homepage
			@seleniumnew.logoutUser($loctGotoLogout, "BS15 - Logout User to completed this."); # Logout
