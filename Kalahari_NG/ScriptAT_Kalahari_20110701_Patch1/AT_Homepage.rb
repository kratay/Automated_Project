...
class Untitled <  Test::Unit::TestCase	  
	...
	def test_untitled
		...
		self.newsletterBoxVerify($HP_sNewEmail, "Enter new email address", true, "HP-17, HP-18")
		self.newsletterBoxVerify($gsExistUser, "Enter registered email address", false, "HP-19, HP-20")
